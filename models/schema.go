...
// Incharge [...]
// models/schema.go - ส่วนของ Incharge model
type Incharge struct {
	...
	Username       string       `gorm:"column:username;type:varchar(100);default:null" json:"username"`
	Password       string       `gorm:"column:password;type:varchar(255);default:null" json:"-"` // json:"-" เพื่อไม่ให้ส่งรหัสผ่านใน response
...
type Training struct {
	...
	StartDate *string `gorm:"column:startdate;type:varchar(10);default:null" json:"startdate"`
	EndDate   *string `gorm:"column:enddate;type:varchar(10);default:null" json:"enddate"`

	// เพิ่มฟิลด์ที่ขาดหายไป
	Coop   int64 `gorm:"column:coop;type:int(11);default:0" json:"coop"`
	Status int64 `gorm:"column:status;type:int(11);default:1" json:"status"`
...
// TrainingRequest is a custom struct for handling API requests with proper date field handling
type TrainingRequest struct {
	...
	TeacherID1     *int64   `json:"teacher_id1"`
	TeacherID2     *int64   `json:"teacher_id2"`
	Address        *string  `json:"address"`
	MoobanID       *int64   `json:"mooban_id"`
	TambonID       *int64   `json:"tambon_id"`
	Tel            *string  `json:"tel"`
	Email          *string  `json:"email"`
	Lat            *float64 `json:"lat"`
	Long           *float64 `json:"long"`
	NameMentor     *string  `json:"name_mentor"`
	PositionMentor *string  `json:"position_mentor"`
	DeptMentor     *string  `json:"dept_mentor"`
	TelMentor      *string  `json:"tel_mentor"`
	EmailMentor    *string  `json:"email_mentor"`
	JobPosition    *string  `json:"job_position"`
	JobDes         *string  `json:"job_des"`
	TimeMentor     *string  `json:"time_mentor"`
	InchargeID1    *int64   `json:"incharge_id1"`
	InchargeID2    *int64   `json:"incharge_id2"`
	Coop           int64    `json:"coop"`
...
type Weekly struct {
	ID         int64          `gorm:"autoIncrement:true;primaryKey;column:id;type:int(11);not null" json:"id"`
	Week       int64          `gorm:"column:week;type:int(11);not null" json:"week"`
	Startdate  string         `gorm:"column:startdate;type:varchar(10);not null" json:"startdate"`
	Enddate    string         `gorm:"column:enddate;type:varchar(10);not null" json:"enddate"`
	TrainingID int64          `gorm:"index:fk_weekly_training_idx;column:training_id;type:int(11);not null" json:"training_id"`
	Job        string         `gorm:"column:job;type:mediumtext;default:null" json:"job"`
	Problem    string         `gorm:"column:problem;type:mediumtext;default:null" json:"problem"`
	Fixed      string         `gorm:"column:fixed;type:mediumtext;default:null" json:"fixed"`
	CourseFixed string        `gorm:"column:course_fixed;type:mediumtext;default:null" json:"course_fixed"`
	Exp        string         `gorm:"column:exp;type:mediumtext;default:null" json:"exp"`
	Suggestion string         `gorm:"column:suggestion;type:mediumtext;default:null" json:"suggestion"`
	Department string         `gorm:"column:department;type:varchar(100);default:null" json:"department"`
	Status     string         `gorm:"column:status;type:varchar(45);default:normal" json:"status"`
	CreatedAt  sql.NullTime   `gorm:"column:created_at;type:datetime;default:now()" json:"created_at"`
